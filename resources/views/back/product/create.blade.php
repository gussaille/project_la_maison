...
@section('content')
    <div class="container">
        ...
        {{--Show Message if fields are not fullfilled--}}
        @if ($errors->any())
                ...
                <div class="col-md-6">
                    ...
                    <div class="form">
                        <div class="form-group">
                            ...
                            <input checked {{ old('status') === 'unpublished' ? 'checked' : null }} type="radio"
                                   id="unpublished"
                                   name="status"
                                   value="unpublished" />
                    ...
                    <div class="form">
                        <div class="form-group">
                            ...
                            <input type="text" name="reference" value="{{ old('reference') }}" class="form-control"
                                   id="reference" minlength="16" maxlength="30" />
                            @if($errors->has('reference'))
                                <span class="error text-danger">{{ $errors->first('reference')}}</span>
                            @endif
                        </div>
                    </div>
